...
- (id)initWithAppKey:(NSString *)appKey
    ...
    if (self) {
        ...
        self.authentication = [[WeiboAuthentication alloc] initWithAuthorizeURL:kWeiboAuthorizeURL revokeAuthorizeURL:kWeiboRevokeAuthorizeURL accessTokenURL:kWeiboAccessTokenURL AppKey:self.appKey appSecret:self.appSecret];
...
- (void)revoke {
    NSURL* revokeUrl = [NSURL URLWithString:self.authentication.revokeAuthorizeRequestUrl];
    ...
    [request setURL:revokeUrl];
    [request setHTTPMethod:@"GET"];
    NSData *returnData = [NSURLConnection sendSynchronousRequest:request
                                               returningResponse:nil error:nil];
    NSString *responseString = [[NSString alloc] initWithData:returnData encoding:NSUTF8StringEncoding];
    NSLog(@"get %@",responseString);
    /*m_is_revoking_autho = true;
     NSMutableURLRequest* request = [NSMutableURLRequest requestWithURL:self.revokeAuthoRequestURL];
